...
static int __init ramoops_memreserve(char *p)
{
	...
	pr_info("msm_reserve_ramoops_memory addr=%llx,size=%llx\n",
			(unsigned long long)ramoops_data.mem_address, (unsigned long long)ramoops_data.mem_size);
	pr_info("msm_reserve_ramoops_memory record_size=%llx,ftrace_size=%llx\n",
			(unsigned long long)ramoops_data.record_size, (unsigned long long)ramoops_data.ftrace_size);
